...
void compareGameStatesAdventurer(struct gameState *gameBefore, struct gameState *gameAfter, int addedTreasure)
{
    ...
    if (numAdventurerHandAfter == numAdventurerHandBefore - 1)
        printf("PASS when checking hand adventurer count (expected = %d, actual = %d, before cardEffect = %d)\n", numAdventurerHandBefore - 1, numAdventurerHandAfter, numAdventurerHandBefore);
    else
        printf("FAIL when checking hand adventurer count (expected = %d, actual = %d, before cardEffect = %d)\n", numAdventurerHandBefore - 1, numAdventurerHandAfter, numAdventurerHandBefore);
    ...
    if (numAdventurerDiscardDeckAfter == numAdventurerDiscardDeckBefore + 1)
        printf("PASS when checking deck/discard adventurer count (expected = %d, actual = %d, before cardEffect = %d)\n", numAdventurerDiscardDeckBefore + 1, numAdventurerDiscardDeckAfter, numAdventurerDiscardDeckBefore);
    else
        printf("FAIL when checking deck/discard adventurer count (expected = %d, actual = %d, before cardEffect = %d)\n", numAdventurerDiscardDeckBefore + 1, numAdventurerDiscardDeckAfter, numAdventurerDiscardDeckBefore);
    ...
    if (numTreasureHandAfter == numTreasureHandBefore + addedTreasure)
        printf("PASS when checking hand treasure count (expected = %d, actual = %d, before cardEffect = %d)\n", numTreasureHandBefore + addedTreasure, numTreasureHandAfter, numTreasureHandBefore);
    else
        printf("FAIL when checking hand treasure count (expected = %d, actual = %d, before cardEffect = %d)\n", numTreasureHandBefore + addedTreasure, numTreasureHandAfter, numTreasureHandBefore);
    ...
    if (numTreasureDiscardDeckAfter == numTreasureDiscardDeckBefore - addedTreasure)
        printf("PASS when checking deck/discard treasure count (expected = %d, actual = %d, before cardEffect = %d)\n", numTreasureDiscardDeckBefore - addedTreasure, numTreasureDiscardDeckAfter, numTreasureDiscardDeckBefore);
    else
        printf("FAIL when checking deck/discard treasure count (expected = %d, actual = %d, before cardEffect = %d)\n", numTreasureDiscardDeckBefore - addedTreasure, numTreasureDiscardDeckAfter, numTreasureDiscardDeckBefore);
    ...
    if (discardDeckCountAfter == discardDeckCountBefore + 1 - addedTreasure)
        printf("PASS when checking deck/discard count (expected = %d, actual = %d, before cardEffect = %d)\n", discardDeckCountBefore + 1 - addedTreasure, discardDeckCountAfter, discardDeckCountBefore);
    else
        printf("FAIL when checking deck/discard count (expected = %d, actual = %d, before cardEffect = %d)\n", discardDeckCountBefore + 1 - addedTreasure, discardDeckCountAfter, discardDeckCountBefore);
...
void runOneRandomTestForAdventurerEffect()
{
    ...
    if (numTreasureInDeck + numTreasureInDiscard == 1)
    {
        ...
        printf("Results from a scenario 1 game (1 treasure added to hand):\n");
        compareGameStatesAdventurer(&gameBefore, &gameAfter, 1);
    ...
    else if (numTreasureInDeck + numTreasureInDiscard >= 2)
    {
        ...
        printf("Results from a scenario 2 game (2 treasure added to hand):\n");
        compareGameStatesAdventurer(&gameBefore, &gameAfter, 2);
    ...
    else // (only remaining logic here is that numTreasureInDeck + numTreasureInDiscard is 0 or less, but negative isn't possible, so we're just left w/ 0)
    {
        ...
        printf("Results from a scenario 3 game (0 treasure added to hand):\n");
        compareGameStatesAdventurer(&gameBefore, &gameAfter, 0);
...
int main()
{
    ...
    // run a bunch of random tests on adventurer effect (includes printouts for pass/fail)
    for (i = 0; i < 1000; ++i)
        runOneRandomTestForAdventurerEffect();
