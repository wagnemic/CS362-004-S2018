 ...
 * this program can run 49 unit tests (so give it an integer 1-49, inclusive)
...
int main(int argc, char *argv[])
{
    ...
    int curTest = 1; // increment this from 1-49 as we go thru test cases and once we reach the one we want (chosenTestCase) return appropriate test case result value
    
    if (chosenTestCase < 1 || chosenTestCase > 49)
        return 2;
