...
int compareGameStatesSmithy(struct gameState *gameBefore, struct gameState *gameAfter, int cardsDrawnFromDeck, int cardsDrawnAfterShuffle)
{
...
int runOneRandomTestForSmithyEffect()
{
    ...
    if (numCardsInDeck >= 3)
    {
        ...
        if (1 == compareGameStatesSmithy(&gameBefore, &gameAfter, 3, 0)) return 1;
    }
    ...
    else if (numCardsInDeck == 2 && numCardsInDiscard >= 1)
    {
        ...
        if (1 == compareGameStatesSmithy(&gameBefore, &gameAfter, 2, 1)) return 1;
    }
    ...
    else if (numCardsInDeck == 2 && numCardsInDiscard == 0)
    {
        ...
        if (1 == compareGameStatesSmithy(&gameBefore, &gameAfter, 2, 0)) return 1;
    }
    ...
    else if (numCardsInDeck == 1 && numCardsInDiscard >= 2)
    {
        ...
        if (1 == compareGameStatesSmithy(&gameBefore, &gameAfter, 1, 2)) return 1;
    }
    ...
    else if (numCardsInDeck == 1 && numCardsInDiscard == 1)
    {
        ...
        if (1 == compareGameStatesSmithy(&gameBefore, &gameAfter, 1, 1)) return 1;
    }
    ...
    else if (numCardsInDeck == 1 && numCardsInDiscard == 0)
    {
        ...
        if (1 == compareGameStatesSmithy(&gameBefore, &gameAfter, 1, 0)) return 1;
    }
    ...
    else if (numCardsInDeck == 0 && numCardsInDiscard >= 3)
    {
        ...
        if (1 == compareGameStatesSmithy(&gameBefore, &gameAfter, 0, 3)) return 1;
    }
    ...
    else if (numCardsInDeck == 0 && numCardsInDiscard == 2)
    {
        ...
        if (1 == compareGameStatesSmithy(&gameBefore, &gameAfter, 0, 2)) return 1;
    }
    ...
    else if (numCardsInDeck == 0 && numCardsInDiscard == 1)
    {
        ...
        if (1 == compareGameStatesSmithy(&gameBefore, &gameAfter, 0, 1)) return 1;
    }
    ...
    else // last remaining option (because numCards in deck or dsicard can't be negative) is that both deck and discard are empty
    {
        ...
        if (1 == compareGameStatesSmithy(&gameBefore, &gameAfter, 0, 0)) return 1;
    }
...
int main(int argc, char *argv[])
{
    ...
    //for (i = 1; i <= 1000; ++i)
    //{
        return runOneRandomTestForSmithyEffect();
    //}
