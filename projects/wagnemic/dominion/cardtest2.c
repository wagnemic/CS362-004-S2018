 ...
 * the tests are:
 * Test 1: Use Smithy from player 0's hand position 1 to draw 3 cards from a deck with 3 cards
 * Test 2: Use Smithy from player 0's hand position 0 to draw 3 cards from a deck with 1 card and a discard with 5 cards (actual cards drawn depends on seed value)
 * Test 3: Use Smithy from player 0's hand position 2 to draw 2 cards from a deck with 0 cards and a discard with 2 cards
 * Test 4: Use Smithy from player 0's hand position 2 to draw 0 cards from a deck with 0 cards and a discard with 0 cards
 *
 */
...
// combines all tests for the smithy card into one function, so i don't have to copy paste them a bunch
void runSmithyTests(struct gameState *expectedGame, struct gameState *actualGame, struct gameState *beforeGame, int cardEffectReturnExpected, int cardEffectReturnActual)
{
...
int main()
{
    ...
    printf("Unit Tests Card 2 - Smithy:\n");
    ...
    // test 1
    printf("Test 1: Use Smithy from player 0's hand position 1 to draw 3 cards from a deck with 3 cards\n");
    ...
    cardEffectReturnActual = cardEffect(smithy, 0, 0, 0, &actualGame, 1, NULL); // choices and bonus are not used in smithy
    ...
    expectedGame.hand[0][expectedGame.handCount[0]++] = gardens;
    ...
    expectedGame.discard[0][expectedGame.discardCount[0]++] = smithy;

    runSmithyTests(&expectedGame, &actualGame, &beforeGame, cardEffectReturnExpected, cardEffectReturnActual);



    // test 2
    printf("Test 2: Use Smithy from player 0's hand position 0 to draw 3 cards from a deck with 1 card and a discard with 5 cards (actual cards drawn depends on seed value)\n");
    ...
    actualGame.discard[0][actualGame.discardCount[0]++] = baron;
    actualGame.discard[0][actualGame.discardCount[0]++] = great_hall;
    actualGame.discard[0][actualGame.discardCount[0]++] = gardens;
    actualGame.discard[0][actualGame.discardCount[0]++] = silver;
    actualGame.discard[0][actualGame.discardCount[0]++] = village;

    memcpy(&beforeGame, &actualGame, sizeof(struct gameState)); // save state of the "before" state of actualGame

    cardEffectReturnActual = cardEffect(smithy, 0, 0, 0, &actualGame, 0, NULL); // choices and bonus are not used in smithy
    cardEffectReturnExpected = 0;
    ...
    expectedGame.hand[0][expectedGame.handCount[0]++] = baron;
    ...
    // test 3
    printf("Test 3: Use Smithy from player 0's hand position 2 to draw 2 cards from a deck with 0 cards and a discard with 2 cards\n");
    ...
    cardEffectReturnActual = cardEffect(smithy, 0, 0, 0, &actualGame, 2, NULL); // choices and bonus are not used in smithy
    cardEffectReturnExpected = 0;
    ...
    // test 4
    printf("Test 4: Use Smithy from player 0's hand position 2 to draw 0 cards from a deck with 0 cards and a discard with 0 cards\n");
